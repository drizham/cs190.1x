...
# wordCountsGrouped = wordsGrouped.map(lambda x: (x[0], len(x[1]) )) # This also works!
...
#                                  - turn k, v to 1 -      - sum the 1s - 
# uniqueWords = len(wordCountsCollected) # works but not ideal
print uniqueWords
